# [FASE 2] Carga y Limpieza: Salud Mental - Consumo SPA
...
ruta_crudos = '../01_datos/raw/r_salud_consumo.xlsx'
print(f"Cargando Consumo Abusivo SPA desde {ruta_crudos} ...")
...
ruta_excel = '../01_datos/processed/p_salud_consumo.xlsx'
...
print("="*40)
print("\U0001f4c4 REPORTE DE LIMPIEZA - CONSUMO SPA")
print("="*40)
