# [FASE 2] Carga y Limpieza: Salud Mental - Suicidio
...
ruta_crudos = '../01_datos/raw/r_salud_suicidio.xlsx'
print(f"Cargando Suicidios desde {ruta_crudos} ...")
...
ruta_excel = '../01_datos/processed/p_salud_suicidio.xlsx'
...
print("="*40)
print("\U0001f4c4 REPORTE DE LIMPIEZA - SUICIDIO")
print("="*40)
