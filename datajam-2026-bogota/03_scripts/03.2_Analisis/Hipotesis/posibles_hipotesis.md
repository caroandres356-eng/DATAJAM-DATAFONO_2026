...
## H13 · El efecto radar y la letalidad invisible

**Hallazgo:** Existe una correlación negativa clara entre el volumen de participación institucional y la letalidad de la crisis. Localidades con baja participación en programas deportivos (como Chapinero o Usaquén) registran las tasas de letalidad más altas de la ciudad (hasta 3.65%). En contraste, localidades con cobertura masiva (como Bosa o Kennedy) logran reducir esta letalidad a niveles cercanos al 1.2%, a pesar de tener volúmenes inmensos de ideación.

**Hipótesis:** La oferta institucional no funciona como un escudo que previene mágicamente la crisis, sino como un radar de detección temprana. A mayor participación, mayor es la probabilidad de que el individuo interactúe con el sistema, pida ayuda o sea identificado en la fase de ideación, evitando que llegue al suicidio consumado. El riesgo en localidades sin oferta no es menor; simplemente es invisible hasta que ocurre la tragedia.

**Gráfica soporte:** `i1_evidencia_radar.png`